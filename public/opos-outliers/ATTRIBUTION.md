...
- License: MIT, as provided by the source project

OutlierDeck uses these files only as character trait artwork. The application code, layout, routing, metadata server, and mint workflow in this repository are original to this build.
